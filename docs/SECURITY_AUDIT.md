...
| `net.ipv4.tcp_timestamps = 0` | ⚠️ Not recommended | Breaks PAWS for wrapped sequence numbers; uptime leakage is a minor risk compared to high-bandwidth connection stability |
